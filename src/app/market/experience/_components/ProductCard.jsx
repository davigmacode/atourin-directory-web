...
export default function ProductCard({ d, onClick }) {
  ...
  return (
    ...
    >
      <div style={pesanStyles.cardImgWrap}>
        ...
        {/* Discount badge below the Best Seller */}
        ...
        {/* Bottom-left: social-proof pill, "27 dipesan hari ini" */}
        {m.hot && (
          <div style={pesanStyles.cardHotPill}>
            <span>🔥</span> {m.bookedToday} dipesan hari ini
          </div>
        )}

        {/* Bottom-right: quick-book CTA on hover */}
      ...
      <div style={pesanStyles.cardBody}>
        ...
        <div style={pesanStyles.cardChips}>
          ...
          {m.freeCancel && (
            <span style={pesanStyles.cardChipFeature}>
              <svg width="10" height="10" viewBox="0 0 24 24" fill="none">
                <path d="M5 12l5 5L20 7" stroke="currentColor" strokeWidth="2.8" strokeLinecap="round" />
              </svg>
              Free cancel
            </span>
          )}
        ...
        <div style={pesanStyles.cardPriceRow}>
          <div style={{ display: "flex", flexDirection: "column" }}>
            {d.strike && <span style={pesanStyles.cardPriceStrike}>Rp {d.strike.toLocaleString("id-ID")}</span>}
          ...
          <span style={pesanStyles.cardPriceUnit}>{d.priceUnit || "/orang"}</span>
        </div>
        ...
        <div style={pesanStyles.cardOperator}>
          ...
          <span title="Mitra terverifikasi" style={pesanStyles.cardOperatorVerify}>
