export const hm = {
  ...
  voucherNotchL: { position: "absolute", left: -33, top: -11, width: 22, height: 22, borderRadius: 999, background: "#fff", border: "1px solid transparent", borderRight: "1px solid var(--atr-outline)", boxShadow: "inset -3px 0 5px rgba(31, 27, 51, 0.05)" },
  voucherNotchR: { position: "absolute", right: -33, top: -11, width: 22, height: 22, borderRadius: 999, background: "#fff", border: "1px solid transparent", borderLeft: "1px solid var(--atr-outline)", boxShadow: "inset 3px 0 5px rgba(31, 27, 51, 0.05)" },
