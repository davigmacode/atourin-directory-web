...
-- ── 3. Seed Data: category_assignments (for category relations) 
...
-- ── 4. Seed Data: facility_assignments (for facility relations)
...
-- ── 5. Seed Data: media (Polymorphic gallery)
