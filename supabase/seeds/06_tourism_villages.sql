...
INSERT INTO directory.tourism_villages (
  ...
  featured, adwi, rating_average, reviews_count,
  homestay_count, homestay_min_price, daily_quota, signature,
...
INSERT INTO directory.category_assignments (category_id, entity_type, entity_id) VALUES
  ((SELECT id FROM directory.categories WHERE slug = 'budaya'), 'village', (SELECT id FROM directory.tourism_villages WHERE slug = 'desa-wae-rebo')),
  ((SELECT id FROM directory.categories WHERE slug = 'alam'), 'village', (SELECT id FROM directory.tourism_villages WHERE slug = 'desa-wae-rebo')),
  ((SELECT id FROM directory.categories WHERE slug = 'desa-wisata'), 'village', (SELECT id FROM directory.tourism_villages WHERE slug = 'desa-wae-rebo')),

  ((SELECT id FROM directory.categories WHERE slug = 'budaya'), 'village', (SELECT id FROM directory.tourism_villages WHERE slug = 'desa-penglipuran')),
  ((SELECT id FROM directory.categories WHERE slug = 'desa-wisata'), 'village', (SELECT id FROM directory.tourism_villages WHERE slug = 'desa-penglipuran')),

  ((SELECT id FROM directory.categories WHERE slug = 'alam'), 'village', (SELECT id FROM directory.tourism_villages WHERE slug = 'desa-nglanggeran')),
  ((SELECT id FROM directory.categories WHERE slug = 'petualangan'), 'village', (SELECT id FROM directory.tourism_villages WHERE slug = 'desa-nglanggeran')),
  ((SELECT id FROM directory.categories WHERE slug = 'desa-wisata'), 'village', (SELECT id FROM directory.tourism_villages WHERE slug = 'desa-nglanggeran')),

  ((SELECT id FROM directory.categories WHERE slug = 'bahari'), 'village', (SELECT id FROM directory.tourism_villages WHERE slug = 'desa-pemuteran')),
  ((SELECT id FROM directory.categories WHERE slug = 'alam'), 'village', (SELECT id FROM directory.tourism_villages WHERE slug = 'desa-pemuteran')),
  ((SELECT id FROM directory.categories WHERE slug = 'desa-wisata'), 'village', (SELECT id FROM directory.tourism_villages WHERE slug = 'desa-pemuteran')),

  ((SELECT id FROM directory.categories WHERE slug = 'alam'), 'village', (SELECT id FROM directory.tourism_villages WHERE slug = 'desa-pentingsari')),
  ((SELECT id FROM directory.categories WHERE slug = 'desa-wisata'), 'village', (SELECT id FROM directory.tourism_villages WHERE slug = 'desa-pentingsari')),

  ((SELECT id FROM directory.categories WHERE slug = 'budaya'), 'village', (SELECT id FROM directory.tourism_villages WHERE slug = 'desa-sasak-sade')),
  ((SELECT id FROM directory.categories WHERE slug = 'desa-wisata'), 'village', (SELECT id FROM directory.tourism_villages WHERE slug = 'desa-sasak-sade')),

  ((SELECT id FROM directory.categories WHERE slug = 'alam'), 'village', (SELECT id FROM directory.tourism_villages WHERE slug = 'desa-wisata-alam-endah')),
  ((SELECT id FROM directory.categories WHERE slug = 'desa-wisata'), 'village', (SELECT id FROM directory.tourism_villages WHERE slug = 'desa-wisata-alam-endah')),

  ((SELECT id FROM directory.categories WHERE slug = 'budaya'), 'village', (SELECT id FROM directory.tourism_villages WHERE slug = 'desa-wisata-ciptagelar')),
  ((SELECT id FROM directory.categories WHERE slug = 'desa-wisata'), 'village', (SELECT id FROM directory.tourism_villages WHERE slug = 'desa-wisata-ciptagelar'));
